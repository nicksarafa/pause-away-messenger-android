...
public class SendReq extends com.google.android.mms.pdu.MultimediaMessagePdu {
     ...
     */
    public SendReq(PduHeaders headers, com.google.android.mms.pdu.PduBody body) {
        super(headers, body);
    }

    public SendReq(PduHeaders headers, com.google.android.mms.pdu.PduBody body, long messageId, long messageBox)
    {
        super(headers, body);
