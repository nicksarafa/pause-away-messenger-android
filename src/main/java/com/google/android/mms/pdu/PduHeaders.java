...
//                }
     ...
     *          with specified header field
     */
    public com.google.android.mms.pdu.EncodedStringValue getEncodedStringValue(int field) {
        return (com.google.android.mms.pdu.EncodedStringValue) mHeaderMap.get(field);
    }
     ...
     *          with specified header field
     */
    public com.google.android.mms.pdu.EncodedStringValue[] getEncodedStringValues(int field) {
        ArrayList<com.google.android.mms.pdu.EncodedStringValue> list =
                (ArrayList<com.google.android.mms.pdu.EncodedStringValue>) mHeaderMap.get(field);
        if (null == list) {
            return null;
        }
        com.google.android.mms.pdu.EncodedStringValue[] values = new com.google.android.mms.pdu.EncodedStringValue[list.size()];
     ...
     * @throws NullPointerException if the value is null.
     */
    public void setEncodedStringValue(com.google.android.mms.pdu.EncodedStringValue value, int field) {
        /**
         * Check whether this field can be set for specific
         * header and check validity of the field.
         */
     ...
     * @throws NullPointerException if the value is null.
     */
    protected void setEncodedStringValues(com.google.android.mms.pdu.EncodedStringValue[] value, int field) {
        /**
         * Check whether this field can be set for specific
         * header and check validity of the field.
         */
        ...
        ArrayList<com.google.android.mms.pdu.EncodedStringValue> list = new ArrayList<com.google.android.mms.pdu.EncodedStringValue>();
     ...
     * @throws NullPointerException if the value is null.
     */
    public void appendEncodedStringValue(com.google.android.mms.pdu.EncodedStringValue value,
                                    int field) {
        if (null == value) {
            throw new NullPointerException();
        }
        ...
        ArrayList<com.google.android.mms.pdu.EncodedStringValue> list =
            (ArrayList<com.google.android.mms.pdu.EncodedStringValue>) mHeaderMap.get(field);
        if (null == list) {
            list  = new ArrayList<com.google.android.mms.pdu.EncodedStringValue>();
        }
        list.add(value);
        mHeaderMap.put(field, list);
    }
