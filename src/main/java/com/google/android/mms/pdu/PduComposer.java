...
public class PduComposer {
    ...
    static {
        ...
        int i;
        for (i = 0; i < com.google.android.mms.pdu.PduContentTypes.contentTypes.length; i++) {
            mContentTypeMap.put(com.google.android.mms.pdu.PduContentTypes.contentTypes[i], i);
        }
    }
