...
public class PauseActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pauseActivityView.startPauseButton.setBackgroundColor(getResources().getColor(R.color.pause_on));
        ...
        pauseActivityView.setPanelSlideListener(new SlidingUpPanelLayout.PanelSlideListener() {
            ...
            public void onPanelAnchored(View view) {
                ...
                pauseActivityView.startPauseButton.setBackgroundColor(getResources().getColor(R.color.pause_off));
