...
/**
 * This view displays a custom selector view which allows a user to adjust a duration of time by
 * manipulating hour and minute selectors and additional time buttons
 */
public class DurationSelectorView extends LinearLayout
   ...
   *
   * @param listener Can be null. The current item changed listener to attach to this view.
   */
  ...
  public String getDurationEndTimeText() {
    String durationText =
        mContext.getString(R.string.pauseMessageDurationPrefix)
            + dateFormat.format(getDurationEndTime().getTime()).toString();
