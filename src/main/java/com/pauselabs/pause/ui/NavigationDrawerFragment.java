...
public class NavigationDrawerFragment extends Fragment implements AdapterView.OnItemClickListener {
   ...
   * it. This shared preference tracks this.
   */
    ...
    drawerToggle =
        new ActionBarDrawerToggle(
          ...
          public void onDrawerOpened(View drawerView) {
            ...
            SavedMessageAdapter savedMessageAdapter =
                (SavedMessageAdapter) mSavedMessageGridView.getAdapter();
            savedMessageAdapter.loadContent();
            if (savedMessageAdapter.getCount() > 0) {
              initialInstructionsContainer.setVisibility(View.GONE);
            }
  ...
  public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
    SavedMessageAdapter savedMessageAdapter =
        (SavedMessageAdapter) mSavedMessageGridView.getAdapter();
    PauseBounceBackMessage savedMessage =
        (PauseBounceBackMessage) savedMessageAdapter.getItem(position);
