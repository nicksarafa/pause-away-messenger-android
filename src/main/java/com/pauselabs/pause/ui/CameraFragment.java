...
public class CameraFragment extends Fragment implements View.OnClickListener {
  ...
  private int mCurrentCameraId =
      Camera.CameraInfo.CAMERA_FACING_BACK; // default to rear facing camera
  ...
  /**
   * This function toggles the front and back facing camera. In order to change cameras we need to
   * first stop current preview, release camera, and rebuild preview with the other camera
   */
  ...
  private void showPreviewScreen() {
    ...
    previewIntent.putExtra(
        Constants.Message.MESSAGE_PARCEL, (android.os.Parcelable) mCurrentPauseBouncebackMessage);
