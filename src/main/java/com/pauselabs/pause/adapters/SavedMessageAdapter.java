        ...
        if (convertView == null) {
            ...
            switch (type) {
                case TYPE_ITEM:
                    ...
                    holder.thumbnailContainer = (FrameLayout) convertView.findViewById(R.id.saveThumbnailContainer);
...
//                Drawable placeholder = mContext.getResources().getDrawable(R.drawable.pause_sms_placeholder);
            ...
            if(savedMessage.isFavorite()){
                holder.favoriteBtn.setImageDrawable(mContext.getResources().getDrawable(R.drawable.ic_favorite));
                holder.thumbnailContainer.setBackground(mContext.getResources().getDrawable(R.drawable.save_thumbnail_background_favorite));

            } else {
                holder.favoriteBtn.setImageDrawable(mContext.getResources().getDrawable(R.drawable.ic_favorite_default));
                holder.thumbnailContainer.setBackground(mContext.getResources().getDrawable(R.drawable.save_thumbnail_background));
            }
        }
