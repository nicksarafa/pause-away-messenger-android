...
/**
 * This is a subclass of CursorAdapter that supports binding Cursor columns to a view layout. If
 * those items are part of search results, the search string is marked by highlighting the query
 * text. An {@link AlphabetIndexer} is used to allow quicker navigation up and down the ListView.
 */
public class ContactsAdapter extends CursorAdapter implements SectionIndexer {
    ...
    holder.checkbox.setOnClickListener(
        new View.OnClickListener() {
          ...
          public void onClick(View v) {
            blacklistContacts =
                prefs.getStringSet(Constants.Settings.BLACKLIST, new HashSet<String>());
  ...
  /**
   * An override of getCount that simplifies accessing the Cursor. If the Cursor is null, getCount
   * returns zero. As a result, no test for Cursor == null is needed.
   */
  @Override
  public int getCount() {
    if (getCursor() == null) {
