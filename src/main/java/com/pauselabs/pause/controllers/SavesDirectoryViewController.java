...
public class SavesDirectoryViewController
  ...
  public SavesDirectoryViewController() {
    ...
    savesDirectoryArrayAdapter =
        new SavesAdapter(savesDirectoryView.getContext(), R.layout.saves_list_item_view);
        ...
        new SweetAlertDialog.OnSweetClickListener() {
          ...
          public void onClick(SweetAlertDialog sweetAlertDialog) {
            ...
            sweetAlertDialog.setContentText(
                "Save #" + (position + 1) + " set as Default reply message!");
