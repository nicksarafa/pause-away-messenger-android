...
public class OnboardingViewController implements View.OnClickListener {
  ...
  public OnboardingViewController(StartActivity activity) {
    ...
    onboardingContainerView =
        (OnboardingContainerView) inflater.inflate(R.layout.ob_container_view, null);
    ...
    onboardingContainerView.viewPager.setAdapter(
        new SectionsPagerAdapter(startActivity.getFragmentManager()));
    onboardingContainerView.viewPager.setOnPageChangeListener(
  ...
  public static class PlaceholderFragment extends Fragment {
    ...
    public View onCreateView(
      ...
      return PauseApplication.startActivity
          .onboardingViewController
          .contentViews[getArguments().getInt(ARG_SECTION_NUMBER)];
    }
  }
}
