...
public class AndroidModule {
  ...
  AudioManager provideAudioManager() {
    return (AudioManager)
        PauseApplication.getInstance().getSystemService(PauseApplication.AUDIO_SERVICE);
  }
  ...
  LayoutInflater provideInflator() {
    return (LayoutInflater)
        PauseApplication.getInstance().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
  }

  @Provides
  TelephonyManager provideTelephonyManager(Context context) {
    return (TelephonyManager)
        PauseApplication.getInstance().getSystemService(Context.TELEPHONY_SERVICE);
  }
